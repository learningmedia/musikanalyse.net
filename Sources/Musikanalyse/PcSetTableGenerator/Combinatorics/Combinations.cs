    ...
    public class Combinations<T> : IMetaCollection<T> {
        ...
        public class Enumerator : IEnumerator<IList<T>> {
            ...
            private void ComputeCurrent() {
                if(this.myCurrentList == null) {
                    ...
                    int index = 0;
                    IList<bool> currentPermutation = (IList<bool>)this.myPermutationsEnumerator.Current;
        ...
        private void Initialize(IList<T> values, int lowerIndex, GenerateOption type) {
            ...
            if(type == GenerateOption.WithoutRepetition) {
                ...
                for(int i = 0; i < this.myLowerIndex; ++i) {
                    myMap.Add(false);
                }
            }
            this.myPermutations = new Permutations<bool>(myMap);
        }
